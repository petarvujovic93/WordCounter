...
{
    public class TextManager : IWordCounterManger
    {
        ...
        {
            var apiManager = new ApiManager<TextCommand, CountResult>();
            return apiManager.Post("v1/word-counter/count", request as TextCommand);
        }
    }
}
